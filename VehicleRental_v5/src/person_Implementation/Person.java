...
{		
	...
	{
		System.out.println( personalIdentificationNumber + ", " + lastName + ", " + firstName + ", " + gender + ", " + drivingLicenseYear + ", " + dateOfBirth);
		return "";
	}
	
	private String extractBirthday(String idNumber)
	{
		String birthday;
