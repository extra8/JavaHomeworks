...
public class ContractLogic implements Contracts
{
	...
	public List<Contract> getContractsFromSource()
	{
		...
		contractList = jdbcTemplate.query(GET_ALL_CONTRACTS, (resultSet, nr)->
		{
			...
			contract.setMileage(Integer.parseInt(resultSet.getString("MILEAGE")));
	...
	{	
		String sql = "INSERT INTO CONTRACTS VALUES('" + c.getRentingDateStart() + "','" + c.getRentingDateEnd() + "'," + c.getMileage() + ",'" + c.getPersonalIdentificationNumber() + "','" + c.getRegistrationNumber() + "');";
